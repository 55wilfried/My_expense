...
class SaveOldExpenseScreen extends StatefulWidget {
  @override
  _SaveOldExpenseScreenState createState() => _SaveOldExpenseScreenState();
}

class _SaveOldExpenseScreenState extends State<SaveOldExpenseScreen> {
  ...
  Future<void> _selectDate(BuildContext context) async {
    final DateTime? picked = await showDatePicker(
      ...
      firstDate: DateTime(2000), // Set an appropriate range for your app
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Save Old Expense"),
        centerTitle: true,
                    ...
                    children: [
                      ...
                      isLoading
                        ...
                        style: ElevatedButton.styleFrom(
                          minimumSize: Size(
                              screenSize.width, screenSize.height * 0.07),
                          shape: RoundedRectangleBorder(
